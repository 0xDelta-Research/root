...
const DiscordIcon = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057c.002.022.015.04.034.05a19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994a.076.076 0 0 0-.041-.106 13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.892.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z" />
  </svg>
);
    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="border border-neutral-800 bg-neutral-900/30 overflow-hidden">
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          {/* Ícone + branding */}
          <div className="flex items-center justify-center p-8 border-b md:border-b-0 md:border-r border-neutral-800 bg-[#5865F2]/5 min-w-[180px]">
            <div className="flex flex-col items-center gap-3 text-center">
              <div className="p-4 border border-[#5865F2]/30 bg-[#5865F2]/10 rounded-sm">
                <DiscordIcon className="w-8 h-8 text-[#5865F2]" />
              </div>
              <span className="text-[9px] font-bold uppercase tracking-widest text-[#5865F2]">DISCORD_SERVER</span>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-8 flex-1">
            <div>
              <p className="text-[10px] text-neutral-500 uppercase tracking-[0.2em] mb-1">Community Channel</p>
              <h3 className="text-lg font-bold text-white font-mono mb-2">0xD3LTA Research</h3>
              <div className="space-y-1">
                <p className="text-xs text-neutral-500 leading-relaxed">
                  Discuss research, share IOCs, collaborate on threat analysis and offensive techniques.
                </p>
                <p className="text-[10px] text-neutral-600 font-mono">
                  // CHANNELS: #general · #blue-team · #red-team · #malware-samples · #threat-intel
                </p>
              </div>
            </div>

            <a
              href="https://discord.gg/SUBSTITUA_AQUI"
              target="_blank"
              rel="noopener noreferrer"
              className="shrink-0 flex items-center gap-2 px-6 py-3 bg-[#5865F2] text-white font-bold text-xs uppercase tracking-widest hover:bg-[#4752C4] transition-colors"
            >
