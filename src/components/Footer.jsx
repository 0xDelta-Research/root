        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex items-start gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 border border-neutral-800 bg-neutral-900 text-neutral-500 hover:text-[#5865F2] hover:border-[#5865F2] hover:bg-[#5865F2]/10 transition-all duration-200"
              aria-label="Discord"
            >
